# Awesome WordPress AI [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)

> A curated list of awesome AI plugins, tools, themes, frameworks, and resources for WordPress.
...
- [WordPress/ai](https://github.com/WordPress/ai) - Official modular framework for testing AI capabilities with opt-in features including alt text generation and content summarization.
...
- [WordPress MCP Adapter](https://github.com/WordPress/mcp-adapter) - Bridges the WordPress Abilities API to the Model Context Protocol, enabling AI agents to discover and invoke WordPress abilities programmatically.
- [AI Provider for Anthropic Claude](https://wordpress.org/plugins/) - Official plugin registering Claude with the PHP AI Client SDK for text generation and function calling.
- [AI Provider for Google Gemini](https://wordpress.org/plugins/) - Official plugin integrating Google Gemini models with support for text generation, image generation, and function calling.
- [AI Provider for OpenAI](https://wordpress.org/plugins/) - Official plugin supporting GPT models, DALL·E, GPT-4 Vision, and text-to-speech.

## Multi-Purpose AI Plugins

Full-featured plugins covering content generation, chatbots, image creation, and more.

- [AI Engine](https://wordpress.org/plugins/ai-engine/) - The most widely-used WordPress AI plugin (80,000+ installs) with chatbots, content generation, AI forms, and MCP integration. [GitHub](https://github.com/jordymeow/ai-engine)
...
- [Jetpack AI Assistant](https://jetpack.com/) - AI-powered content generation directly in the WordPress block editor via Jetpack infrastructure.
...
- [SureForms](https://wordpress.com/plugins/sureforms) - AI-powered form builder with smart suggestions and native integrations with Google Sheets, Mailchimp, and FluentCRM.
- [WPForms AI](https://wpforms.com/) - Conversational AI form builder generating complex forms with payment options and conditional logic.
...
Plugins implementing the [Model Context Protocol](https://modelcontextprotocol.io/) for WordPress.

- [WordPress MCP Adapter](https://github.com/WordPress/mcp-adapter) - Official WordPress MCP adapter bridging the Abilities API to MCP-compatible AI agents.
- [Royal MCP](https://wordpress.org/plugins/royal-mcp/) - Implements Model Context Protocol for WordPress, giving AI platforms structured access to site content.
- [WordPress WAE](https://github.com/kradyy/wordpress-wae) - Comprehensive MCP integration providing 45 carefully designed abilities for AI agent interaction.

## Hosting & Site Builders

Managed WordPress hosting platforms with integrated AI website builders.
